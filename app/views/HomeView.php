...
require_once 'navbar.php' ?>
    ...
    <div class="container-fluid about-section">
                    <h1 class="mb-4 text-dark text-center ">About FitForge</h1>
        <div class="container">
            <div class="row align-items-center gx-5">
                <div class="col-md-6">
                    <img src="<?= ROOT ?>/assets/images/gym1.jpg" class="img-fluid rounded" alt="About FitForge">
                </div>
                <div class="col-md-6 text-center text-md-start">
                    <p class="fs-5 text-dark ">FitForge is your ultimate destination for fitness enthusiasts. Create personalized
                        workout plans, connect with top trainers, and explore a wide range of exercises to achieve your
                        fitness goals. Whether you're a beginner or a seasoned athlete, FitForge provides the tools and
                        motivation you need to succeed.</p>
